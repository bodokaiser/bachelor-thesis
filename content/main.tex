...
\newcommand{\measuredir}[1]{../measurement/#1}
...
\include{chapter/tunnelling-in-optical-lattices}
\include{chapter/power-transfer-in-acousto-optics}
\include{chapter/digital-signal-synthesis}
\include{chapter/experimental-setup}
\include{chapter/experimental-results}
