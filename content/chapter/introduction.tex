...
One major parameter to interact with the ultracold atom ensembled in the
...
\begin{figure}[ht]
  ...
  \captionsetup{width=.9\textwidth}
  \caption{Cubic 2D optical lattice optical lattice. The atoms (blue) sit on
    their respective lattice site created by the superposition of two
    periodic potentials.}\label{fig:optical_lattice}
\end{figure}
The atoms (blue) sit on their respective lattice sites which are created by the
superposition of two optical potentials (outer diagrams). In such periodic
structures the atomic wave functions already show amazing similarity to the
electron wave functions known from solid states physics. Nevertheless one can
think of many different variations to the simple lattice structure depicted
in \Cref{fig:optical_lattice} inclduing hexagonal lattice structures or
lattices with lattice substructure known as superlattices.

Beside of the changes of the global lattice
