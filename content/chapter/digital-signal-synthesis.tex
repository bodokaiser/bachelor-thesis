...
\begin{figure}[ht]
  ...
  {\figuredir{digital-signal-synthesis/simple-architecture.pdf}}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=\textwidth]
  {\figuredir{digital-signal-synthesis/simple-output.pdf}}
  \captionsetup{width=.9\textwidth}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=\textwidth]
  {\figuredir{digital-signal-synthesis/clock-generation.pdf}}
  \captionsetup{width=.9\textwidth}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=\textwidth]
  {\figuredir{digital-signal-synthesis/modulation-architecture.pdf}}
  \captionsetup{width=.9\textwidth}
