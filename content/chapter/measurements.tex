...
\begin{figure}[ht]
  \centering
  \includegraphics[width=.9\textwidth]{\figuredir{signal/synthesis/spectrogram.pdf}}
  \captionsetup{width=.7\textwidth}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=.9\textwidth]{\figuredir{signal/synthesis/frequency-max-amplitude.pdf}}
  \captionsetup{width=.7\textwidth}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=.9\textwidth]{\figuredir{signal/amplification/frequency-max-amplitude.pdf}}
  \captionsetup{width=.7\textwidth}
  \caption{}
