...
The maximum permissible time in between site visits of our potential
generating laser beam is bound by the quantum tunneling amplitude. It has to
be smaller then the expected time for an atom to tunnel to another lattice
site. In this chapter we want to recapitulate the theoretical foundations
for optical lattices and find an expression to estimate the order of
magnitude of a theoretically required sweep duration.

\section{Atom-field interactions}

% Introduction to Quantum Optics
% https://jila.colorado.edu/arey/sites/default/files/Llecture25_sp_16.pdf
