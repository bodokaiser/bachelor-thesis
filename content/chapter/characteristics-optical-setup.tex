...
to also conduct a short term measurement. For the short term measurement time
parameters were adjusted to a sample interval of \SI{10}{\second} and
measurment were performed over \SI{1}{\hour}. The intensity time series of the
short term measurement is depicted in \Cref{fig:intensity_control} and
the associated descriptive statistics are presented in
\Cref{tab:intensity_control}.
...
do not see outliers in \Cref{fig:intensity_control} we can pay more
...
Another parameter we did not consider so far is the leverage of the beam
polarisation. That is why we conducted changed the polarisation angle of the
$\lambda/4$ plate in front of Cube 2 in \Cref{fig:intensity_control_setup}.
...
\end{figure}
\Cref{fig:intensity_distribution_polarisation_broad} and
\Cref{fig:intensity_distribution_polarisation_narrow} show how the intensity
