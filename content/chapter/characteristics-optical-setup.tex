...
\begin{figure}[ht]
  \centering
  \includegraphics[width=\textwidth]{\figuredir{intensity/distribution/unpaired-tilted.png}}
  \captionsetup{width=.8\textwidth}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=\textwidth]{\figuredir{intensity/distribution/unpaired-polarisation-broad.png}}
  \captionsetup{width=.8\textwidth}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=\textwidth]{\figuredir{intensity/distribution/unpaired-polarisation-narrow.png}}
  \captionsetup{width=.8\textwidth}
