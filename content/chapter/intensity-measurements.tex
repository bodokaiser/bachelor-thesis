...
position and acknowledged that \gls{aod} in general may differ significant
in their properties. In the present section we now want to explore the
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=\textwidth]{\figuredir{intensity/distribution/sample-frequency.pdf}}
  \captionsetup{width=.8\textwidth}
  \caption{Intensity distribution over linear frequency sweep at different
  configured \gls{dds} amplitudes for different individual \gls{aod}
configurations.}
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=\textwidth]{\figuredir{intensity/distribution/paired-frequency-residue.pdf}}
  \captionsetup{width=.8\textwidth}
  \caption{Intensity distribution over linear frequency sweep at different
  configured \gls{dds} amplitudes for different individual \gls{aod}
configurations.}
