...
\section{Generic Periodic Potentials}
...
In the tight-binding approximation the potentials are considered deep such
that interaction between neighbooring particles is limited. In the optical
case potentials can be easily made deep by increasing the intensity.

\subsection{Harmonic Case}
