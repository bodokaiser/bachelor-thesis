...
For horizontal and vertical beam deflection two \gls{aom}s, namely \gls{aom} V
and \gls{aom} H, are used. A $1:1$ telescope comprised of two lenses L2, L3
...
% how does a dds work (lookup table)
...
% theory of amplitude and ramp modulation
