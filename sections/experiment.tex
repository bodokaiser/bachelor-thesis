...
Two \gls{aom} are used for \gls{v} and \gls{h} beam deflection as a
...
source and temperature fluctuations. With \gls{aom} \gls{h} and \gls{aom}
\gls{v} we will refer to the \gls{aom}s used for beam deflection in the
